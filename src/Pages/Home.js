...
import SelectMovie from "../Components/SelectAMovie";
import SelectSeats from "../Components/SelectTheSeats";
import TimeShedule from "../Components/SelectATimeSlot";
...
const Home = (props) => {
  ...
  return (
    <>
      <Modal />
      <h1 className="state">Book that show!!</h1>
      ...
      <button onClick={() => {handleBookNow();}}className="BN-btn ">Book Now </button>
    </>
  );
};
